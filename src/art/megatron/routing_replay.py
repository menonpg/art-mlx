...
def _target_rank_token_count_slice(
    rank_token_counts: tuple[int, ...] | None,
) -> tuple[int, int] | None:
    if (
    ...
    start = sum(rank_token_counts[:rank])
    return start, start + int(rank_token_counts[rank])
