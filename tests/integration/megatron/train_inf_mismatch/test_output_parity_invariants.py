...
def test_architecture_specific_real_path_limits() -> None:
    ...
    assert fwd_mean_abs_pct_limit_for_model("Qwen/Qwen3-32B") == 5.0
    assert fwd_mean_abs_pct_limit_for_model("Qwen/Qwen3.5-27B") == 5.0
    ...
    assert top20_kl_candidate_to_target_limit_for_model("Qwen/Qwen3.5-27B") == 0.004
    assert (
